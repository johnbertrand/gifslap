...
if(images.randomize_order){
  ...
  images.set_array.push( images.set_array[images.cursor], images.set_array[images.cursor+1] );

  // overwrite the current and next images with our saved images  
  images.set_array[images.cursor] = '".$_POST['active_image']."';
  images.set_array[images.cursor+1] = '".$_POST['next_active_image']."';

  // set the background and inner background
  bg_mod.box.attr('style','".$_POST['bg_style']."');
  inner_bg_mod.box.attr('style','".$_POST['inner_bg_style']."');
